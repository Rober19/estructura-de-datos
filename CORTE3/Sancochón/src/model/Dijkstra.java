...
public class Dijkstra {
    ...
    public Dijkstra(Tree arboles, int tope, int permanente, int nodoFin) {
    ...
    public void dijkstra() {
        ...
        if (permanente != nodoFin) {
            ...
            Draw.clickSobreNodo(PanelGeneral.getGraphics(), arboles.getCordeX(permanente), arboles.getCordeY(permanente), null, Color.GREEN); // pinta de color GREEN los nodos
            ...
            while (auxi.getPredecesor() != null) {
                Draw.pintarCamino(PanelGeneral.getGraphics(), arboles.getCordeX(auxi.getNombre()), arboles.getCordeY(auxi.getNombre()), arboles.getCordeX(auxi.getPredecesor().getNombre()), arboles.getCordeY(auxi.getPredecesor().getNombre()), Color.GREEN);
                Draw.clickSobreNodo(PanelGeneral.getGraphics(), arboles.getCordeX(auxi.getNombre()), arboles.getCordeY(auxi.getNombre()), null, Color.GREEN);
                auxi = auxi.getPredecesor();
            }
            Draw.clickSobreNodo(PanelGeneral.getGraphics(), arboles.getCordeX(nodoFin), arboles.getCordeY(nodoFin), null, Color.GREEN);
        } else {
            Draw.clickSobreNodo(PanelGeneral.getGraphics(), arboles.getCordeX(nodoFin), arboles.getCordeY(nodoFin), null, Color.GREEN);
        }
    }
